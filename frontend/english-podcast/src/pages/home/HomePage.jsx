    ...
    <div className="flex ">
      ...
      <div className="container p-4">
        <div className="flex justify-end p-4 gap-4">
          <Menu className="flex justify-center content-center">
        ...
        <div>
          <h2 className="font-bold text-green-700 text-xl">Recently played</h2>
        </div>
        <div>
          <h2 className="font-bold text-green-700 text-xl">Shows to try</h2>
        </div>
        <div>
          <h2 className="font-bold text-green-700 text-xl">Popular podcast</h2>
        </div>
      </div>
    </div>
  );
